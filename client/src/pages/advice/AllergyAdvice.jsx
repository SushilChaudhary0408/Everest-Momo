...
function AllergyAdvice() {
    ...
    const arr = [
        {
            tilte: 'For the Dough',
            list: ['120 gms refined flour', '1/4 tsp baking powder', '1/2 tsp salt water (for kneading)']
        },
        {
            tilte: 'For the Chicken Filling:',
            list: ['Text="1 cup chicken (minced)";', 'Text="1/2 cup onions, finely chopped";', 'Text="1/4 tsp black pepper powder";', 'Text="1 tbsp oil";', 'Text="1/2 tsp garlic paste";', 'Text="1/2 tsp soya sauce";', 'Text="Salt";', 'Text="1/4 tsp vinegar";']
        },
        {
            tilte: 'For the Vegetarian Filling:',
            list: ['Text="1 cup cabbage and carrots, grated";', 'Text="2 tbsp onions , finely chopped";', 'Text="1/2 tsp garlic, finely chopped";', 'Text="1 tbsp oil";', 'Text="1/4 tsp vinegar";', 'Text="1/2 tsp soya sauce";', 'Text="to taste salt";', 'Text="to taste pepper";', 'Text="1 tbsp cornflour";']
        },
        {
            tilte: 'For Chilli Sauce:',
            list: ['Text="25 gram garlic, peeled";', 'Text="6 gms whole red chillies";', 'Text="3 tbsp vinegar";', 'Text="3 tbsp vinegar";', 'Text="1 tbsp oil";', 'Text="to taste salt";', 'Text="to taste salt";', 'Text="to taste sugar";']
        },
    ]

    const paragraphs = [
        "Lorem ipsum dolor sit amet consectetur. Feugiat lectus sit est blandit in gravida. Nisl facilisis luctus sit porttitor placerat purus tincidunt. Cursus nascetur a mauris odio quis sociis pretium nisl. In viverra diam dis montes orci congue vulputate magna ullamcorper. Semper tellus ipsum felis maecenas ultrices turpis amet Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio labore omnis ea. Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, et eveniet cum pariatur cumque sed molestiae! Quas laboriosam dignissimos quod! euismod malesuada. Amet sed neque vitae malesuada quis sed urna.",
        ...
        <div className=' overflow-hidden'>
            ...
            <div className='mt-14 md:mt-24 flex items-center justify-center text-center'>
                <div className=' flex flex-col lg:flex-row gap-2 lg:gap-3 justify-center items-center text-center  '>
                    ...
                    <div class="h-[48px] flex items-center text-[#D95103] flex-none flex-grow-0 text-[40px] leading-[120%] font-chela font-normal gap-3">
                        <span className=''> Ingredients </span> <span className='text-customBlack'> Used </span>
                    </div>
            ...
            <div className='mt-auto lg:mt-32 xl:mt-auto'>
                <div className='mt-14 md:mt-24 flex justify-center items-center text-center'>
                    <div className=' flex flex-col lg:flex-row gap-2 lg:gap-3 justify-center items-center   '>
                        <img src={Advice02} alt="" className='' />
                        <div class="h-[48px]  text-[#D95103]  flex-none flex-grow-0 text-[40px] leading-[120%] font-chela font-normal gap-3 ">
                            <span> Allergy </span><span className=' text-customBlack'> Advice </span>
                        </div>
                        <img src={Advice03} alt="" />
                    </div>
                </div>
                <div className='mt-10 flex justify-center items-center w-full'>
                    ...
                    <div className='flex flex-col justify-center items-center gap-8 w-[80%]'>
                        {paragraphs.map((text, index) => (
                            <p key={index} className={`text-[#252D43] ${index === paragraphs.length - 1 ? 'flex justify-between' : ''}`}>
                                {text}
                            </p>
                        ))}
                    </div>
